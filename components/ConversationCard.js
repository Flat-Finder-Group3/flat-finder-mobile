import { View, StyleSheet, Text, Button, StatusBar, FlatList, RefreshControl } from 'react-native';
import { Avatar } from 'react-native-paper';
import GradientAvatar from './GradientAvatar';
import { TouchableOpacity } from 'react-native';


export default function ConversationCard({item, navigation, messages, onPress}){
  ...
  return (
    <TouchableOpacity onPress={handleOnPress}>
      <View style={globalStyles.outline}>
        ...
        <GradientAvatar size={80} gradientColors={gradientColors} initials={initials}/>}
        <View style={{flex: 1}}>
